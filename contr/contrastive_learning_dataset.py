...
from view_generator import ContrastiveLearningViewGenerator, WatermarkViewGenerator
import os
...
class ContrastiveLearningDataset:
    ...
    def get_dataset(self, name, n_views):
        valid_datasets = {'cifar10': lambda: datasets.CIFAR10(self.root_folder, train=True,
                          ...
                          'stl10': lambda: datasets.STL10(f"../ssl-attacks-defenses/dataset//stl10", split='unlabeled',
                                                          transform=ContrastiveLearningViewGenerator(
                                                              self.get_simclr_pipeline_transform(32),
                                                              n_views),
                                                          download=True),
                          ...
                          'imagenet': lambda: datasets.ImageNet(
                              root="../ssl-attacks-defenses/imagenet256/",
                              split='train',
                              transform=ContrastiveLearningViewGenerator(
                                  self.get_simclr_pipeline_transform(
                                      224),
    ...
    def get_test_dataset(self, name, n_views):
        valid_datasets = {'cifar10': lambda: datasets.CIFAR10(self.root_folder, train=False,
                          ...
                          'stl10': lambda: datasets.STL10(f"../ssl-attacks-defenses/dataset/stl10", split='test',
                                                          transform=ContrastiveLearningViewGenerator(
                                                              self.get_simclr_pipeline_transform(32),
                                                              n_views),
                                                          download=True),
                          ...
                          'svhn': lambda: datasets.SVHN(self.root_folder+"/SVHN",
                                                        ...
                                                        download=True),
                          'imagenet': lambda: datasets.ImageNet(
                              root="../ssl-attacks-defenses/dataset/imagenet256/",
                              split='val',
                              transform=ContrastiveLearningViewGenerator(
                                  self.get_simclr_pipeline_transform(
                                      224),
    ...
    def get_dataset(self, name, n_views):
        valid_datasets = {'cifar10': lambda: datasets.CIFAR10(self.root_folder, train=True, 
                          ...
                          'svhn': lambda: datasets.SVHN(self.root_folder+"/SVHN",
                                                        ...
                                                        download=True),
                          'imagenet': lambda: datasets.ImageNet(
                              root="../ssl-attacks-defenses/dataset/imagenet_pytorch/",
                              split='train',
                              transform=ContrastiveLearningViewGenerator(
